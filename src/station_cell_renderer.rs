...
//
// #[repr(C)]
// pub struct StationCellRendererClass {
//     pub parent_class: gtk_sys::GtkCellRendererTextClass,
// }
//
// pub struct StationCellRendererPrivate {
//     pub num: i32,
...
// }
//
// unsafe fn to_gtk_rect(rect: *const gdk_sys::GdkRectangle) -> gtk::Rectangle {
//     gtk::Rectangle {
//         x: (*rect).x,
//         y: (*rect).y,
//         width: (*rect).width,
...
//
// glib_wrapper! {
//      pub struct StationCellRenderer(Object<c_void>): [
//          gtk::CellRenderer => gtk_sys::GtkCellRenderer
//      ];
//
//      match fn {
//          get_type => || get_type(),
